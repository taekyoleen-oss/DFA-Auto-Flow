...
/**
 * 고급기능(AI 파이프라인 생성 / AI 데이터 분석 / 모델 분석보고서 생성 / 코드 보기·내보내기 /
 * API 키 설정 등 API·코드 관련 기능) 잠금 게이트.
 *
 ...
 *
 * DFA 적응점: localStorage 키는 ML(mlaf_…)과 충돌하지 않도록 dfa_advanced_unlocked를 쓴다.
 */
...
const STORAGE_KEY = 'dfa_advanced_unlocked';
