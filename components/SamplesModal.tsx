 ...
 * DFA: app_section "DFA", 모델 파일 .lifx/.json/.mla
 */
...
const SamplesModal: React.FC<SamplesModalProps> = ({
  ...
  const handleEditOpen = (sample: Sample) => {
    ...
    setEditForm({
      name: sample.name,
      category: sample.category || "DFA기타",
  ...
  const filteredSamples =
    selectedCategory === "전체"
      ...
      : samples.filter((sample) => {
          ...
          if (selectedCategory === "XoL") return c === "XoL" || c === "XOL";
          if (selectedCategory === "DFA기타") return c === "DFA기타" || c === "기타";
              ...
              <form onSubmit={handleRegisterSubmit} className="max-w-2xl mx-auto space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="DFA기타">DFA기타</option>
                  </select>
                </div>
                <div>
                  ...
                  >
                    ...
                    <div className="space-y-3 mb-4 flex-1">
                      <div>
                        ...
                        <span className="text-gray-900 dark:text-white text-sm">{sample.category || "DFA기타"}</span>
                      </div>
