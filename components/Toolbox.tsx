...
export const Toolbox: React.FC<ToolboxProps> = ({ onModuleDoubleClick, onFontSizeChange }) => {
  ...
  const SHAPE_MODULES = [
    { type: ModuleType.TextBox, name: '텍스트 상자', icon: DocumentTextIcon, description: "텍스트를 입력할 수 있는 상자를 추가합니다." },
    { type: ModuleType.GroupBox, name: '그룹 상자', icon: RectangleStackIcon, description: "선택된 모듈들을 그룹으로 묶는 상자를 추가합니다." },
  ];
