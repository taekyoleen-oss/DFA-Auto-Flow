...
const ToolboxItem: React.FC<{
  ...
  return (
    <div
      ...
      draggable
      title={description}
      className="flex items-center gap-2 px-3 py-1.5 text-xs bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 rounded-md font-semibold text-gray-900 dark:text-white transition-colors whitespace-nowrap w-full text-left cursor-grab"
    >
              ...
              {SHAPE_MODULES.map(({ type, name, icon: Icon, description }) => {
                ...
                if (type === ModuleType.GroupBox) {
                  return (
                    <div
                      ...
                      title={name}
                      className="relative group flex items-center justify-center w-6 h-6 rounded cursor-pointer bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 hover:text-blue-400 transition-colors"
                    >
                ...
                return (
                  <div
                    ...
                    draggable
                    title={name}
                    className="relative group flex items-center justify-center w-6 h-6 rounded cursor-grab bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 hover:text-blue-400 transition-colors"
                  >
                    <Icon className="h-3.5 w-3.5" />
                    {/* Tooltip */}
          ...
          {categorizedModules.map((category) => (
            <div key={category.name}>
              <button
                ...
                className="w-full flex items-center justify-between p-2 rounded-lg text-left text-sm font-semibold text-gray-900 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
              >
